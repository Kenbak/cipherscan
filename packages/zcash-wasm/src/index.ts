/**
 * @cipherscan/zcash-wasm
 *
 * Client-side WASM library for Zcash shielded transaction decryption
 * and compact block filtering.
 *
 * Features:
 ...
 * @example
 * ```typescript
 * import { ZcashWASM } from '@cipherscan/zcash-wasm';
 *
