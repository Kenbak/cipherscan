...
function AppContent({ children }: { children: React.ReactNode }) {
  return (
    <>
      ...
      <footer className="footer-container border-t mt-12 sm:mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 items-center">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-xs sm:text-sm footer-text-secondary mb-1 sm:mb-2">
                Zcash Blockchain Explorer
              </p>
              <p className="text-xs footer-text-muted font-mono">
          ...
          {/* Bottom: Copyright */}
          <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t footer-border text-center">
            <p className="text-xs footer-text-muted">
