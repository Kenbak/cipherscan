  ...
  return (
    ...
    >
      ...
      <ol className="mt-5 grid gap-5 md:grid-cols-3">
        <li>
          <h3 className="text-sm font-medium text-primary"><span className="mr-2 font-mono text-cipher-cyan">01</span>Open a supported wallet</h3>
          ...
          <div className="mt-2 flex flex-wrap gap-x-4 gap-y-2 text-xs text-cipher-cyan">
        ...
        <li>
          <h3 className="text-sm font-medium text-primary"><span className="mr-2 font-mono text-cipher-cyan">02</span>Check your eligible balance</h3>
          ...
          {snapshotHeight !== undefined && (
            <Link href={`/block/${snapshotHeight}`} className="mt-2 inline-block text-xs text-cipher-cyan hover:underline">
              This poll’s snapshot: block {snapshotHeight.toLocaleString('en-US')} →
            </Link>
          )}
        </li>
        <li>
          <h3 className="text-sm font-medium text-primary"><span className="mr-2 font-mono text-cipher-cyan">03</span>Review, choose &amp; submit</h3>
      ...
      <div className="mt-5 border-t border-cipher-border-subtle pt-3 text-xs leading-relaxed">
        <p className="text-secondary">
          ...
          <a href={ZODL_GUIDE} target="_blank" rel="noopener noreferrer" className="text-cipher-cyan hover:underline">Wallet guide ↗</a>
        </p>
