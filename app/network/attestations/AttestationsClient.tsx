          ...
          <dd className="text-sm text-secondary">
            {endpoint.baseline ? <>
              {endpoint.baseline.tag && endpoint.baseline.tagReferenceUrl
                ? <a href={endpoint.baseline.tagReferenceUrl} target="_blank" rel="noopener noreferrer" className="font-mono text-cipher-cyan hover:underline break-all">{endpoint.baseline.tag}<span aria-hidden="true" className="ml-1">↗</span></a>
