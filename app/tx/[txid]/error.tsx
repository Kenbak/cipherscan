...
/**
 * Route-level error boundary for `/tx/[txid]`. Catches render-time
...
export default function TxError({
  ...
  useEffect(() => {
    console.error('[transaction detail] render error:', error);
  }, [error]);
      ...
      <Card role="alert" ariaLive="assertive">
        <CardBody>
          <div className="text-center py-12">
            <div className="w-14 h-14 mx-auto mb-5 rounded-xl bg-cipher-surface border border-white/[0.04] flex items-center justify-center" aria-hidden="true">
