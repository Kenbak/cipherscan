      ...
      <main className="flex-1 py-12 px-4 lg:px-12 max-w-5xl">
        ...
        <div className="card gradient-card-purple mb-12">
          ...
          <div className="space-y-2 text-sm text-secondary">
            ...
            <p>
              <strong className="text-primary">Testnet Only:</strong> This API currently serves Zcash testnet data.
        ...
        <div className="space-y-12">
          {categories.map((category) => (
            <section key={category.name} className="space-y-6">
              <h2 className="text-2xl sm:text-3xl font-bold font-mono sticky top-0 docs-category-header backdrop-blur py-4 z-10 border-b border-cipher-border text-primary">
                {category.name}
              </h2>
