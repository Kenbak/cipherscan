...
const WALLETS: { name: string; status: WalletStatus; detail: string; link: string | null }[] = [
  ...
  { name: 'ZODL (iOS)', status: 'zip318', detail: 'v3.9.0 uses the zcash_pool_migration crate via the iOS SDK for ZIP-318 compliant gradual migration with Tor protection and Keystone support.', link: 'https://zodl.com/' },
  { name: 'ZODL (Android)', status: 'zip318', detail: 'v3.9.0 uses the zcash_pool_migration crate via the Android SDK for ZIP-318 compliant migration with automatic background execution and Tor protection.', link: 'https://zodl.com/' },
