      ...
      <Card>
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <Badge color="gold">{totalTxCount}</Badge>
          </div>
              ...
              <div className="overflow-x-auto -mx-6 px-6">
                ...
                <div className="space-y-2 min-w-[800px]">
                  {sortedTxs.map((tx, index) => (
                    <div key={tx.txid || index} onClick={() => router.push(`/tx/${tx.txid}`)} className="grid grid-cols-12 gap-3 items-center block-tx-row p-3 rounded-lg border border-cipher-border hover:border-cipher-gold transition cursor-pointer group">
                      {/* Type Column */}
                      ...
                      <div className="col-span-1">
                        {tx.blockHeight ? (
                          <Link
                            ...
                            className="text-xs text-cipher-gold hover:underline"
                          >
                            #{tx.blockHeight}
                          </Link>
                        ) : (
                        ...
                        <div className="flex items-center gap-1 text-xs text-secondary font-mono">
                          {tx.isDeshielding ? (
                            ...
                            <>
                              ...
                              <span className="text-muted text-caption">Private Transaction</span>
                            </>
                          ) : tx.isCoinbase ? (
                            <>
