      ...
      {loading ? (
        ...
        <ResponsiveContainer width="100%" height={320}>
          <ComposedChart data={points}>
            ...
            <Bar dataKey="shield" fill={colors.cyan} fillOpacity={0.6} radius={[2, 2, 0, 0]} name="shield" />
            <Bar dataKey="deshield" fill={deshieldColor} fillOpacity={0.4} radius={[0, 0, 2, 2]} name="deshield" />
            <Line
              type="monotone"
              dataKey="net"
