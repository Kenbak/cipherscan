...
const privacy = {category:'Privacy',endpoint:'/v1/privacy/stats?days=90',rows:'trends.daily',x:'date',window:'90 days',href:'/privacy#trends'};
const pools = {category:'Supply & flows',endpoint:'/v1/shielded-pools/history?period=all',rows:'points',x:'date',window:'All available history',href:'/pools#supply'};
const valuation = {category:'Valuation',endpoint:'/v1/valuation/history?period=1y',rows:'points',x:'date',window:'1 year',href:'/valuation#price'};
...
const ages = {category:'Valuation',endpoint:'/v1/valuation/dormancy?period=1y',rows:'points',x:'date',window:'1 year',href:'/valuation#dormancy'};
...
export const CHART_CATALOG: CatalogChart[] = [
  ...
  {id:'fees',title:'Observed transaction fees',category:'Mining & network',description:'Daily median and 10th/90th percentiles of observed fees. This is not a fee quote.',href:'/network#network-activity',endpoint:'/v1/network/fee-distribution?period=30d',rows:'daily',x:'date',window:'30 days',unit:'mZEC',series:[series('p10','10th percentile','transparent',1e-5),series('median','Median','gold',1e-5),series('p90','90th percentile','sprout',1e-5)]},
